...
def Review(request,pk):
    ...
    if request.method == "POST":
        ...
        for f in cmd.split():
            ...
            elif f in ('alone', 'break', 'blame', 'depressed', 'deserveunhappy', 'die', 'escap', 'feelalone', 'feltpain', 'no job', 'tooworried'):
                se = 'Depression'
...
def CreateTweet(request):
    ...
    if request.method == "POST":
        ...
        for f in cmd.split():
            ...
            elif f in ('alone', 'break', 'blame', 'depressed', 'deserve unhappy', 'die', 'escap', 'feel alone', 'felt pain', 'no job', 'too worried'):
                se = 'Depression'
